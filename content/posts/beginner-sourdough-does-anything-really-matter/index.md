...
4.  **Steps:** The bulk of the recipe, from crucial technique to flourishes and rituals.### Component Ratio
...
Other components are usually expressed in baker’s percentages too, like 2% salt is standard.### Component Ingredients
...
Once we’re ready to experiment more, we can toss in some herbs, cheese, seeds, the possibilities are endless!### Time, Temperature, and Yeast
...
4.  **Rest and Add Salt:** Many recipes are _very serious_ about leaving the salt and a bit of water until after mixing the bulk of the dough and water. The theory is that salt leeches moisture from the flour so it won’t be absorbed as evenly if we do it all at once. Once we mix in the salt, the feel of the dough instantly changes into something much less shaggy and less sticky, it’s delightful. 
